 ...
 * parameter's mode is in the hundreds digit, the second parameter's mode is in the thousands
 * digit, the third parameter's mode is in the ten-thousands digit, and so on. Any missing
 * modes are 0.
 *
